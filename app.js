...
const sources = galleryItems.reduce((total, galleryItem) => {
  total.push(galleryItem.original);
  return total;
}, []);
console.log(sources);
...
function onGalleryClick(event) {
  ...
  function onKeyDown(event) {
    const currentIndex = sources.indexOf(lightboxImage.src);
...
function leftClick(currentIndex) {
  ...
  lightboxImage.src = sources[nextIndex];
}
